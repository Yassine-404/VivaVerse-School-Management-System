<nav class="navbar navbar-light">
    <div class="navbar-left">
        <div class="logo-area">
            <a class="navbar-brand" href="{{ route('dashboard.etudiant',app()->getLocale()) }}">
            ...
            <div class="hexadash-top-menu position-relative">
                <ul>
                    <li class="has-subMenu">
                        <a href="#" class="{{ Request::is(app()->getLocale().'/dashboards/*') ? 'active':'' }}">Tableau de bord</a>
                    </li>
                    <li class="has-subMenu">
                    ...
                    <li class="has-subMenu">
                        <a href="#" class="{{ Request::is(app()->getLocale().'/etudiant/*') ? 'active':'' }}">Crud</a>
                        <ul class="subMenu">
                            <li class="has-subMenu-left">
                                <a href="#" class="{{ Request::is(app()->getLocale().'/etudiant/*') ? 'active':'' }}">
                                    <span class="nav-icon uil uil-database"></span>
                                    <span class="menu-text">{{ trans('menu.etudiant-crud-menu-title') }}</span>
                                </a>
                                <ul class="subMenu">
                                    <li><a class="{{ Request::is(app()->getLocale().'/etudiant/list') ? 'active':'' }}" href="{{ route('etudiant.list',app()->getLocale()) }}">{{ trans('menu.etudiant-view-all') }}</a></li>
                                    <li><a class="{{ Request::is(app()->getLocale().'/etudiant/create') ? 'active':'' }}" href="{{ route('etudiant.create',app()->getLocale()) }}">{{ trans('menu.etudiant-add-new') }}</a></li>
                                </ul>
                            </li>
                        </ul>
                    </li>
        ...
        <ul class="navbar-right__menu">
            <li class="nav-search">
                ...
                <form action="/" class="search-form-topMenu">
                    ...
                    <input class="form-control me-sm-2 box-shadow-none" type="search" placeholder="Entrez un mot..." aria-label="Search">
                </form>
            </li>
            <li class="nav-author">
