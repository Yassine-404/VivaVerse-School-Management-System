                            ...
                            <div class="card border-0">
                                <div class="card-header">
                                    <div class="edit-profile__title">
                                        <h6>Connectez-vous à VivaVerse</h6>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <form action="{{ route('authenticate') }}" method="POST">
                                        ...
                                        <div class="edit-profile__body">
                                            <div class="form-group mb-20">
                                                ...
                                                <input type="text" class="form-control" id="email" name="email" placeholder="email@vivaverse.cm">
                                                @if($errors->has('email'))
                                                    <p class="text-danger">L'adresse e-mail est invalide</p>
                                                @endif
                                            </div>
                                            <div class="form-group mb-15">
                                                <label for="password-field">Mot de passe</label>
                                                <div class="position-relative">
                                                    <input id="password-field" type="password" class="form-control" name="password" placeholder="Mot de passe">
                                            ...
                                            <div class="admin-condition">
                                                ...
                                                <a href="{{ route('forget_password') }}">Mot de pase oublié?</a>
                                            </div>
